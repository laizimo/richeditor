...
RE.insertImage = function(url, alt) {
    var html = '<div><progress id="'+url+'" max="100" value="20"></progress><img  src="' + url + '" alt="' + alt + '" /><p align=center style="color:#aaaaaa">来自YUOER的图片</p><hr align=center width=200 color=#aaaaaa size=1 /><br/><br/></div>';
    RE.insertHTML(html);
}
...
RE.updateProgress = function(id,v){
    var element = document.getElementById(id);
    if(element){
        element.value = v;
    }
